...
Run these routines to get persistent entropy and the ALPS statistic (cf. ALPS statistic calculation in the ["Example from <i>Science</i>"](rep_plot)).
...
Then, we can plot the ALPS statistic across all the frames.
...
Finally, we plot the results of the hypothesis testing
