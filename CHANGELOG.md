...
- Error with `plot_hypo` from 0.5.5 has been addressed. 
- Incomplete documentation for PD thresholding arguments. 
...
- how `ImageSeriesPlus` dealt with infinite values in calculating PH.
